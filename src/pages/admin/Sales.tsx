...
export const Sales: React.FC = () => {
  ...
  const generatePDF = (order: any) => {
    try {
        ...
        const deepBlue = [20, 35, 80];      // #142350 - Dark Navy (Headers/Footer)
        const mediumBlue = [40, 80, 160];   // #2850A0 - Primary Blue
        const brightBlue = [60, 130, 240];  // #3C82F0 - Highlight Blue
        const lightBlue = [220, 235, 255];  // #DCEBFF - Very light background
